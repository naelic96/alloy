...
FROM --platform=$BUILDPLATFORM image-registry.openshift-image-registry.svc:5000/monitoring-preprod-axa-it/alloy-custom:init AS ui-build
ARG BUILDPLATFORM
...
FROM --platform=$BUILDPLATFORM image-registry.openshift-image-registry.svc:5000/monitoring-preprod-axa-it/alloy-custom:init AS build
...
FROM image-registry.openshift-image-registry.svc:5000/monitoring-preprod-axa-it/ubuntu-nooble:nooble
